...
class ImpressionTest {
  ...
  void impressionsIdThrows(String id) {
    assertThrows(Exception.class,()->new Impression("2015-01-01 24:00:02",id,"12.5","Shopping"));
  }

  @ParameterizedTest
  @ValueSource(strings = {"-1","-5"})
  void impressionsCostThrows(String cost) {
    assertThrows(Exception.class,()->new Impression("2015-01-01 24:00:02","25",cost,"Shopping"));
  }
